...
var exec = require('cordova/exec');
 ...
 CordovaPlugin.prototype.startMosambeePayment = function(successCallback,errorCallback,orderId,completionTenderAmount,customerEmailId,customerMobileNo){
    var options = {};
    options.orderId = orderId;
    options.completionTenderAmount = completionTenderAmount;
    options.customerEmailId = customerEmailId;
    options.customerMobileNo = customerMobileNo;
   cordova.exec(successCallback,errorCallback,'MosambeePlugin','startMosambeePayment',[options]);
 }
